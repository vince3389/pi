...
#Install and configure an MQTT broker on the Raspberry Pi. Mosquitto is a popula                                                               r MQTT broker that you can install by running the command:
...
#   Install the w1thermsensor library for reading the temperature from the DS18B                                                               20 sensor by running:
...
command3 = ["python3", "/home/sensor/DHT11.py", "&"]
...
mqtt_password = "ul2aip8oe4kuu5ooruf4ishah1naig5ae8ookaich5iech9Ied2ookoonuquaiG                                                               h"  # Replace with your MQTT password
